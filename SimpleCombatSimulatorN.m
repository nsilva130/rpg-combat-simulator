...
% This version of the program is capable of simulating multiple sequences
% of combat and counting how many each creature won. It will also log each
% individual combat.
clear all
close all
clc
...
c1name = input('Input first creature''s name: ','s');
...
c2name = input('Input second creature''s name: ','s');
...
t = 1; 
cis = num2str(ci);
name = strcat(c1name,'_VS_',c2name,'_Combat_',cis,'.txt');
diary(name)
diary on
...
cis = '0'; %String variable of number of combats
...
while tracker == 1
    ...
    fprintf('Combat %i, Round %i, Turn %i. \n',ci,r,t)
    pause(1)
...
fprintf('Of %i combat simulations, Creature 1 won %i and Creature 2 won %i. \n',c,w1,w2)
